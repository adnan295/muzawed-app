...
const defaultSections = [
  ...
  },
  {
    icon: FileText,
    title: 'الشروط العامة',
    content: 'باستخدامك لمنصة مزود، فإنك توافق على الالتزام بشروط الخدمة. نحتفظ بالحق في تعديل الأسعار والشروط دون إشعار مسبق. جميع الأسعار معروضة بالليرة السورية ولا تشمل ضريبة القيمة المضافة.',
  },
];
