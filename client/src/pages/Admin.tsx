...
const LazySiteSettingsSection = lazy(() => import('./admin/SiteSettingsSection'));
const LazyAccountDeletionRequestsSection = lazy(() => import('./admin/AccountDeletionRequestsSection'));
...
function AccountDeletionRequestsSection() {
  return (
    <Suspense fallback={<div className="py-8 text-center text-gray-400">جاري التحميل...</div>}>
      <LazyAccountDeletionRequestsSection />
    </Suspense>
  );
}
